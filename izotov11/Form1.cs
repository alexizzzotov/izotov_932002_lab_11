...
namespace izotov11
{
    public partial class Form1 : Form
    {
        ...
        private void freq(BTN Alhoritm)
        {
            ...
            stat.MeanAvailable();
            label4.Text = stat.E + "  (погрешность: " + stat.EErr + "%)";
            label5.Text = stat.D + "  (погрешность: " + stat.DErr + "%)";
        ...
        class Statistica
        {
            ...
            {
                if ((double)Chi < 11.07) return "Хи-квадрат: " + Math.Round((double)Chi, 3) + "  <  11.07  /  true";
                return "Хи-квадрат: " + Math.Round((double)Chi, 3) +  "  >  11.07  /  false";
            }
